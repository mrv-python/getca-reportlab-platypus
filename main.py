...
# Imports
from reportlab.platypus import SimpleDocTemplate, Paragraph, Spacer, HRFlowable, PageBreak, Image, ListFlowable, ListItem, Table, TableStyle
...
t_style = TableStyle([
    ...
    ("BACKGROUND", (1, 1), (1, 1), ("HORIZONTAL", "red", "white"))
    ])
